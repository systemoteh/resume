...
<%@ attribute name="education" required="false" type="ru.systemoteh.resume.domain.Education" %>
    ...
    <div class="panel-body ui-item">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-md-12 ${hasError ? 'has-error has-feedback' : ''}">
                ...
                <textarea class="form-control" name="items[${index }].summary" id="items${index}summary"
