...
<%@ attribute name="language" required="false" type="ru.systemoteh.resume.domain.Language" %>

<div id="ui-item-${index }" class="panel panel-default">
    <div class="panel-body ui-item">
        <div class="row">
            <div class="col-xs-12">
                <button type="button" class="close" onclick="$('#ui-item-${index }').remove();"><span
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-md-9">
                ...
                <div style="padding: 0 30px;">
                    <resume:form-input-slider index="${index }"
