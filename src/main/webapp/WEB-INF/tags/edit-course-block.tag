...
<%@ attribute name="course" required="false" type="ru.systemoteh.resume.domain.Course" %>
                ...
                <div class="row">
                    <div class="col-xs-6">
                        <select id="items${index }finishDateMonth" name="items[${index }].finishDateMonth"
                                class="form-control" onchange="resume.ui.updateSelect($(this))"
                                data-ref-select="items${index }finishDateYear">
                    ...
                    <div class="col-xs-6">
                        <select id="items${index }finishDateYear" name="items[${index }].finishDateYear"
                                class="form-control" onchange="resume.ui.updateSelect($(this))"
                                data-ref-select="items${index }finishDateMonth">
                            <option value="">Not finished yet</option>
