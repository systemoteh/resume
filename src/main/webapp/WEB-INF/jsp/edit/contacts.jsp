            ...
            <div class="row">
                <div class="col-sm-7">
                    ...
                    <div class="form-group ${hasError ? 'has-error' : ''}">
                        ...
                        <div class="col-sm-8">
                            <form:input path="skype" class="form-control" id="inputSkype" placeholder="Example: john-doe" />
                ...
                <div class="col-sm-5 help-block">
                    <blockquote>
                        ...
                        3. Если у Вас нет адекватного Skype логина, значит пришло время его создать
                    </blockquote>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-7">
                    ...
                    <div class="form-group ${hasError ? 'has-error' : ''}">
                        ...
                        <div class="col-sm-8">
                            <form:input path="vkontakte" class="form-control" id="inputVkontakte" placeholder="Example: https://vk.com/john-doe" />
                    ...
                    <div class="form-group ${hasError ? 'has-error' : ''}">
                        ...
                        <div class="col-sm-8">
                            <form:input path="facebook" class="form-control" id="inputFacebook" placeholder="Example: https://facebook.com/john-doe" />
                    ...
                    <div class="form-group ${hasError ? 'has-error' : ''}">
                        ...
                        <div class="col-sm-8">
                            <form:input path="linkedin" class="form-control" id="inputLinkedin" placeholder="Example: https://linkedin.com/john-doe" />
                    ...
                    <div class="form-group ${hasError ? 'has-error' : ''}">
                        ...
                        <div class="col-sm-8">
                            <form:input path="github" class="form-control" id="inputGithub" placeholder="Example: https://github.com/john-doe" />
                    ...
                    <div class="form-group ${hasError ? 'has-error' : ''}">
                        ...
                        <div class="col-sm-8">
                            <form:input path="stackoverflow" class="form-control" id="inputStackoverflow" placeholder="Example: https://stackoverflow.com/john-doe" />
