    ...
    <div class="panel-body">
        ...
        <form:form action="/sign-up" commandName="profileForm" method="post">
            ...
            <div class="help-block text-justify">
                Имейте ввиду, что введенные Вами имя и фамилия не смогут быть изменены в будущем! Поэтому предоставляйте
            ...
            <div class="form-group ${hasError ? 'has-error has-feedback' : ''}">
                ...
                <form:input path="firstName" id="firstName" cssClass="form-control" placeholder="Example: Jonh"
                            required="required"/>
            ...
            <div class="form-group ${hasError ? 'has-error has-feedback' : ''}">
                ...
                <form:input path="lastName" id="lastName" cssClass="form-control" placeholder="Example: Doe"
                            required="required"/>
            ...
            <a href="/fbSignUp" class="btn btn-primary pull-right"><i class="fa fa-facebook"></i>&nbsp;&nbsp;
