                ...
                <sec:authorize access="hasAuthority('USER')">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu profile-menu">
                            ...
                            <li><a href="/edit"><i class="fa fa-pencil"></i> Редактировать профиль</a></li>
            ...
            <form action="/search" method="get" class="navbar-form navbar-right" role="search">
                <div class="form-group">
                    <input class="form-control" placeholder="Search" name="query"
                           value="${query}" data-toggle="tooltip" data-placement="bottom"
                           title="start with '~' for full-text search">
                </div>
